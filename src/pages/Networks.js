  ...
  return (
    <div className="relative bg-black w-full h-[64rem] overflow-hidden text-left text-[1.13rem] text-grey font-inter">
      <img
        ...
        src="/bg1.svg"
      />
      <div className="absolute top-[7.38rem] left-[2.81rem] w-[14.56rem] h-[49.81rem]">
        <div
        ...
        <div className="absolute top-[4.63rem] left-[0rem] flex flex-col items-start justify-start gap-[2.25rem]">
          ...
          <div className="relative w-[14.56rem] h-[3.5rem]">
            ...
            <div className="absolute top-[1rem] left-[1.13rem] flex flex-row items-start justify-start gap-[1.19rem]">
              <img
                className="relative w-[1.5rem] h-[1.5rem] overflow-hidden shrink-0"
                alt=""
