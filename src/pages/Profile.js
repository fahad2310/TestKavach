  ...
  return (
    <div className="relative bg-black w-full h-[64rem] overflow-hidden text-left text-[1.13rem] text-grey font-inter">
      <img
        ...
        src="/bg.svg"
      />
      <div className="absolute top-[7.38rem] left-[2.81rem] w-[14.63rem] h-[49.81rem]">
        <div
          className="absolute top-[0rem] left-[0rem] flex flex-row items-start justify-start gap-[1.19rem] cursor-pointer text-white"
        ...
        <div className="absolute top-[4.25rem] left-[0.06rem] flex flex-col items-start justify-start gap-[2.25rem]">
          <div className="relative w-[7rem] h-[1.5rem]">
          ...
          <div className="relative w-[11.31rem] h-[1.5rem]">
            <div className="absolute top-[0rem] left-[0rem] flex flex-row items-start justify-start gap-[1.19rem]">
              <img
          ...
          <div className="relative w-[13.13rem] h-[1.5rem]">
            <div className="absolute top-[0rem] left-[0rem] flex flex-row items-start justify-start gap-[1.19rem]">
              <img
                className="relative w-[1.5rem] h-[1.5rem] overflow-hidden shrink-0"
                alt=""
          ...
          <div className="relative w-[7.88rem] h-[1.5rem]">
            <div className="absolute top-[0rem] left-[0rem] flex flex-row items-start justify-start gap-[1.19rem]">
              <img
                className="relative w-[1.5rem] h-[1.5rem] overflow-hidden shrink-0"
                alt=""
          ...
          <div className="relative w-[7.25rem] h-[1.5rem]">
            <div className="absolute top-[0rem] left-[0rem] flex flex-row items-start justify-start gap-[1.19rem]">
              <img
                className="relative w-[1.5rem] h-[1.5rem] overflow-hidden shrink-0"
                alt=""
          ...
          <div className="relative rounded-2xl bg-darkgreen w-[14.56rem] h-[3.5rem]">
        ...
        <div className="absolute top-[48.31rem] left-[0rem] flex flex-row items-start justify-start gap-[1.19rem]">
          <img
            className="relative w-[1.5rem] h-[1.5rem] overflow-hidden shrink-0"
            alt=""
            src="/logout1-1.svg"
